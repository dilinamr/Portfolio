export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/17_4AUoF-kj5kdwHXt_N4IDLPFEtmRX-Q/view?usp=sharing",
...
export const experiences = [
  {
    id: 0,
    img: "https://images.app.goo.gl/ZDhDwKZNK3EabVvTA",
    role: "FULL STACK DEVELOPER",
    company: "Beta Squirrel Pvt. Ltd.",
    date: "jan 2022 - present",
    // desc: "Working on Flipr Platforms, managing DevOps, and streamlining the process with automation.",
    skills: ["React", "JavaScript", "TypeScript", "Node Js", " Next Js"],
